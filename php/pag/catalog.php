                    ...
                    <div class="el-overlay">
                        <ul class="list-style-none el-info">
                            <li class="el-item">
                              ...
                              el-link
                            " href="../assets/images/big/img1.jpg"><i class="mdi mdi-magnify-plus"></i></a>
                            </li>
                            <li class="el-item">
                    ...
                    <div class="el-overlay">
                        <ul class="list-style-none el-info">
                            <li class="el-item">
                              ...
                              image-popup-vertical-fit
                              el-link
                            " href="../assets/images/big/img2.jpg"><i class="mdi mdi-magnify-plus"></i></a>
                            </li>
                            <li class="el-item">
                                <a class="btn default btn-outline el-link" href="javascript:void(0);"><i
                                        class="mdi mdi-link"></i></a>
                    ...
                    <div class="el-overlay">
                        <ul class="list-style-none el-info">
                            <li class="el-item">
                              ...
                              image-popup-vertical-fit
                              el-link
                            " href="../assets/images/big/img3.jpg"><i class="mdi mdi-magnify-plus"></i></a>
                            </li>
                            <li class="el-item">
                                <a class="btn default btn-outline el-link" href="javascript:void(0);"><i
                                        class="mdi mdi-link"></i></a>
                    ...
                    <div class="el-overlay">
                        <ul class="list-style-none el-info">
                            <li class="el-item">
                              ...
                              image-popup-vertical-fit
                              el-link
                            " href="../assets/images/big/img4.jpg"><i class="mdi mdi-magnify-plus"></i></a>
                            </li>
                            <li class="el-item">
                                <a class="btn default btn-outline el-link" href="javascript:void(0);"><i
                                        class="mdi mdi-link"></i></a>
                    ...
                    <div class="el-overlay">
                        <ul class="list-style-none el-info">
                            <li class="el-item">
                              ...
                              image-popup-vertical-fit
                              el-link
                            " href="../assets/images/big/img5.jpg"><i class="mdi mdi-magnify-plus"></i></a>
                            </li>
                            <li class="el-item">
                                <a class="btn default btn-outline el-link" href="javascript:void(0);"><i
                                        class="mdi mdi-link"></i></a>
                    ...
                    <div class="el-overlay">
                        <ul class="list-style-none el-info">
                            <li class="el-item">
                              ...
                              image-popup-vertical-fit
                              el-link
                            " href="../assets/images/big/img6.jpg"><i class="mdi mdi-magnify-plus"></i></a>
                            </li>
                            <li class="el-item">
                                <a class="btn default btn-outline el-link" href="javascript:void(0);"><i
                                        class="mdi mdi-link"></i></a>
