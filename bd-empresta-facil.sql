...
-- A despejar dados para tabela empresta_facil.biblioteca: ~2 rows (aproximadamente)
DELETE FROM `biblioteca`;
INSERT INTO `biblioteca` (`id`, `nome`, `morada`, `cod_postal`, `criado_em`, `atualizado_em`, `ativo`) VALUES
	(1, 'Biblioteca de Gaia', 'Vila Nova de Gaia', '111-3333', '2025-05-25 10:00:57', NULL, 'Y'),
	(2, 'Biblioteca dos Tangas', 'Tanga Moradias', '4400-332', '2025-05-25 10:11:32', NULL, 'Y');
...
CREATE TABLE IF NOT EXISTS `emprestimo` (
  ...
  CONSTRAINT `emprestimo_ibfk_1` FOREIGN KEY (`recurso_fk`) REFERENCES `livro` (`id`),
...
CREATE TABLE IF NOT EXISTS `emprestimo_recurso` (
  ...
  CONSTRAINT `emprestimo_recurso_ibfk_2` FOREIGN KEY (`recurso_fk`) REFERENCES `livro` (`id`),
...
-- A despejar dados para tabela empresta_facil.livro: ~5 rows (aproximadamente)
DELETE FROM `livro`;
INSERT INTO `livro` (`id`, `titulo`, `isbn`, `ano_lancamento`, `sinopse`, `idioma`, `quantidade`, `editora_fk`, `categoria_fk`, `subcategoria_fk`, `criado_em`, `atualizado_em`, `ativo`) VALUES
	(22, 'Ze das mangas 1243', '9781234567895', 2024, 'dasdas', 'Portunhol', 4, 2, 3, 1, '2025-06-09 15:56:30', '2025-06-09 23:30:23', 'Y'),
	(23, 'Ze das Mangas', '9781234567894', 2022, 'sdasd', 'Portunhol', 2, 1, 1, 1, '2025-06-12 21:12:42', '2025-06-12 22:27:48', 'Y'),
	(24, 'Ameaça Continua Mata Porcos', '9781234567810', 2021, 'sadd', 'Português', 2, 1, 1, 1, '2025-06-12 21:14:24', NULL, 'Y'),
	(26, 'Livro de teste com autores gays', '9781234567888', 2015, 'dadas', 'Português', 4, 1, 1, 1, '2025-06-12 22:35:58', NULL, 'Y'),
	(28, 'A ameaça agora é outra', '9781234567778', 2011, 'dasd', 'Português', 3, 1, 1, 1, '2025-06-12 22:40:34', NULL, 'Y');
...
-- A despejar dados para tabela empresta_facil.localizacao: ~5 rows (aproximadamente)
DELETE FROM `localizacao`;
INSERT INTO `localizacao` (`id`, `cod_local`, `biblioteca_fk`, `criado_em`, `atualizado_em`, `ativo`) VALUES
	(3, 'A1', 1, '2025-05-25 10:46:57', NULL, 'Y'),
	(4, 'A2', 1, '2025-05-25 10:46:57', NULL, 'Y'),
	(5, 'A1', 2, '2025-05-25 10:46:57', NULL, 'Y'),
	(6, 'B1', 2, '2025-05-25 10:46:57', NULL, 'Y'),
	(10, 'A4', 1, '2025-05-25 11:03:05', NULL, 'Y');
...
-- A despejar dados para tabela empresta_facil.tipo_recurso: ~5 rows (aproximadamente)
DELETE FROM `tipo_recurso`;
INSERT INTO `tipo_recurso` (`id`, `tipo`, `descricao`, `criado_em`, `atualizado_em`, `ativo`) VALUES
	(1, 'Livro', 'Livros Homessexuais', '2025-06-02 15:43:55', NULL, 'Y'),
	(2, 'Calculadora', '', '2025-06-02 15:45:29', NULL, 'Y'),
	(3, 'Banda Desenhada', '', '2025-06-02 15:46:06', NULL, 'Y'),
	(4, 'Didático', '', '2025-06-02 15:46:16', NULL, 'Y'),
	(5, 'Livro bem homossexual', 'aaa dsdf', '2025-06-02 15:54:52', NULL, 'Y');
