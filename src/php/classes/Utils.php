...
class Utils
{
        ...
        try {
            ...
            <body>
                ...
                <div class="content">
                    ...
                    <p><strong>Importante:</strong> Você tem até a data de levantamento para retirar o livro. Após essa data, a reserva será considerada expirada.</p>
                </div>
    ...
    public static function notifyLoanExpiration($email, $firstName, $bookTitle, $libraryName, $libraryAddress)
    {
        try {
            ...
            $phpmailer->CharSet = 'UTF-8';
            $phpmailer->isHTML(true);
            $phpmailer->Subject = 'Alerta: Seu Empréstimo Expirou';
